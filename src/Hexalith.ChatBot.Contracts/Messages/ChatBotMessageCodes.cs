...
public static class ChatBotMessageCodes
{
    ...
    public const string OutboundChannelQuarantined = "outbound_channel_quarantined";
    public const string OutboundChannelRateLimited = "outbound_channel_rate_limited";
}
