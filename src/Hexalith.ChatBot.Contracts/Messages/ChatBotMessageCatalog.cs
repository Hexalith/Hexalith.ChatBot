...
public static class ChatBotMessageCatalog
{
    ...
    [
        ...
        new(
            ...
            ChatBotDetailVisibility.MetadataOnly),
        new(
            ChatBotMessageCodes.AiActorQuarantined,
            "AI actor quarantined.",
            "This AI actor is contained for review; its proposals are held until a policy administrator reviews and releases it.",
            ChatBotMessageNextActions.RequestAccess,
            ChatBotDisabledActionReasons.DisabledAction,
            ChatBotDetailVisibility.MetadataOnly),
        new(
            ChatBotMessageCodes.AiActorRateLimited,
            "AI actor rate limited.",
            "This AI actor's proposal capacity is temporarily limited to protect reviewers; retry shortly.",
            ChatBotMessageNextActions.RetryLater,
            ChatBotDisabledActionReasons.DependencyDegraded,
            ChatBotDetailVisibility.MetadataOnly),
        new(
            ChatBotMessageCodes.CommandCapabilityDisabled,
            "Command disabled by policy.",
            "This command is blocked for the tenant until a policy administrator re-enables it.",
            ChatBotMessageNextActions.RequestAccess,
            ChatBotDisabledActionReasons.DisabledAction,
            ChatBotDetailVisibility.MetadataOnly),
        new(
            ChatBotMessageCodes.CommandCapabilityQuarantined,
            "Command quarantined for review.",
            "This command is contained for review and is held until a policy administrator reviews and releases it.",
            ChatBotMessageNextActions.RequestAccess,
            ChatBotDisabledActionReasons.DisabledAction,
            ChatBotDetailVisibility.MetadataOnly),
        new(
