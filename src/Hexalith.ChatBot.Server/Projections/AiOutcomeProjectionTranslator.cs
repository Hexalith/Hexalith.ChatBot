...
internal static class AiOutcomeProjectionTranslator
{
    ...
    public static AiOutcomeEventView? TryCreateView(PublishedAiOutcomeEvent published)
    {
        ...
        return new AiOutcomeEventView(
            ...
            SafeOptionalToken(published.PolicyReasonCode),
            SafeOptionalToken(published.ClassifierVersion),
            SafeOptionalToken(published.RiskInputTuple),
            SafeOptionalToken(published.RequesterAuthorityClass),
            SafeOptionalToken(published.IndeterminateReason),
