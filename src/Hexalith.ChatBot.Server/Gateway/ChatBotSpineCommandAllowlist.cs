...
internal sealed class ChatBotSpineCommandAllowlist : ISpineCommandAllowlist
{
    private static readonly HashSet<string> AllowedCommandTypes =
        new(StringComparer.Ordinal)
        {
            ...
            nameof(SubmitOutboundChannelDisable),
            nameof(ApproveOutboundChannelDisable),
            nameof(SubmitOutboundChannelQuarantine),
            nameof(ApproveOutboundChannelQuarantine),
            ...
            nameof(SubmitOutboundChannelRateLimit),
