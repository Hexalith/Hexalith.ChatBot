...
created: "2026-09-14"
updated: "2026-09-14"
workspaceRevision: 5d5d5bb62c76b4a500a3f8c4d332161a34642b66
recheckStatus: material-gaps-recorded
recheckArtifact: review-source-integrity-recommended-update-2026-09-14.md
refreshTriggerArtifact: reconcile-recommended-final-2026-09-14.md
refreshVerificationArtifact: review-source-integrity-recommended-update-2026-09-14.md
a13BaselineArtifact: reconcile-full-sibling-a13-2026-09-14.md
---
...
| `review-rubric.md` | SHA-256 `03bb83d63ec7ef0f06d9ccccc6744a65aa6740f5e0a256840cc171b4a125eea7` | 2026-09-14 current rubric findings at source-integrity refresh |
| `validation-report.md` | SHA-256 `36ae55891e388ff0a571afc98c3adda9764521f0c65492ebca5f049f3dc68cce` | 2026-09-14 synthesized validation input at source-integrity refresh |
...
| --- | --- | --- |
| Hexalith.Conversations | `f0ea587f809defbe34e8458df051ec446ad73fec` | Conversation identity and messages |
| Hexalith.Projects | `4f05a352edd67c4d5595913ee584539c1948dd58` | Project identity, membership, and project boundary |
| Hexalith.Folders | `4c64f6165ecf01075352d9f03dd8d6e1bd17f4b1` | Governed file and folder records |
...
| Hexalith.EventStore | `555c904769db111c77a78674ee8d83ec64ffa6b9` | Command/event durability and canonical audit envelope, payload protection, and erasure boundary |
| Hexalith.FrontComposer | `b0ad2fb69bcf5e7aadd7b388d25415d0fba876d5` | Governed UI shell and interactive chat surface |
| Hexalith.Memories | `5829db422522b79c0d164df85adde53a996ba114` | Optional AI memory dependency |
| Hexalith.Commons | `19d7d4d6b21160557b7449f55a0ad0f55e6d7dc6` | Shared contracts and primitives |

These revisions identify the checked-out dependency baseline at the 2026-09-14 source-integrity refresh; no submodule was initialized or updated for the refresh. Revisions do not by themselves prove acceptance of a proposed cross-context contract. All previously listed consumed-file hashes remain unchanged except `AggregateActor.cs`, whose current delta propagates an existing no-op result payload into terminal completion and does not by itself establish or close ChatBot's atomic-audit contract. The new correction rows below are explicitly open A13 requirements. `IdentityEvolved` remains unaccepted until the producer contracts named in the addendum are approved.

## Consumed contract baseline

These SHA-256 values bind the files inspected at the sibling revisions above. Existing compatibility dispositions remain open where stated; the added correction rows identify current candidate or missing producer contracts and do not claim owner acceptance.
...
| Conversations | `src/Hexalith.Conversations.Contracts/Commands/ReassignConversationProjectCommand.cs`, `ConversationProjectAssignment.cs`, and `ConversationProjectAssignmentOperation.cs`; `src/Hexalith.Conversations.Contracts/Events/ConversationProjectChanged.cs`; `src/Hexalith.Conversations.Server/CommandHandlers/ReassignConversationProjectCommandHandler.cs` — current reassignment candidate | `c2bdafb9295bbfb5ee62116d1e65e1263a8e884891319d74ecd350e761573689`; `515fa769ef28fe8206c6d876213d298171bb011ca264d4cc8212dc8b7595d5f7`; `b1fd24979a90f799d4ef5dd056f757bcb10f796e1d8c3ac3b536798a7228760b`; `8ceba54cf07a49786d40d738878e31326a9b0b8bf31cbc7a14fac83ee2ec2057`; `c9c846584fed69c0d76c23e0f1d6792982956dd80c75c26f21c306c87ff39526` | **Open A13; candidate only, not accepted:** the checkout exposes assignment/clear, an expected-current-Project guard, an event, and a handler. ChatBot still requires owner acceptance and contract tests for dual-Project authority, lifetime idempotency/concurrency, atomic audit, correction-manifest correlation, authenticated acknowledgement, compensation/error semantics, and replay. |
...
| Folders | `src/Hexalith.Folders.Contracts/openapi/hexalith.folders.v1.yaml` — current `AddFile`, `ChangeFile`, `RemoveFile`, and absence of a correction-specific reassignment/quarantine/revoke/governed-copy acknowledgement contract | `a953a7d3bf6e3b1f99542ba8d20720047c1aa316d7a80d6725a28e96f834c420` | **Open A13; missing required producer contract:** existing file mutation routes do not define FR91a's cross-Project correction authority, compensation choice, immutable source/destination linkage, idempotent acknowledgement, or terminal outcome. No ChatBot assumption may substitute for a versioned Folders owner contract and acceptance tests. |
...
| EventStore | `src/Hexalith.EventStore.Server/Events/IEventPersister.cs` and `src/Hexalith.EventStore.Server/Actors/AggregateActor.cs` — one-aggregate event-batch durability | `0965e71e28d3c7ac520aa49aa7b45fa6f91509a38cbd0c7df7572ca4dd59532b`; `8cb98de791376bc2ed3c322fd865d818a8cc5ddef2ed6ae09e77f3a84acda06f` | Conditionally compatible: domain plus audit events can co-commit in one aggregate; terminal idempotency does not co-commit. The refreshed actor hash includes no-op result-payload propagation and does not close A13. |
...
`reconcile-full-sibling-a13-2026-09-14.md` remains the original nine-context A13 review baseline; this manifest's current-revision refresh supersedes its revision identities and adds the open Conversations/Folders correction requirements. The two must not be read as owner acceptance. A8 governs allowlist membership; executable append, correction, authority, audit, and fencing acceptance belong to A13. A6, A13, or A12 cannot be closed by repository revision alone.
