...
- Use repo-pinned stack only: .NET SDK `10.0.302`, `net10.0`, warnings-as-errors, central package management, Dapr/Aspire pins, xUnit v3, Shouldly, NSubstitute. Do not add package versions inline or casually upgrade vendor SDKs.
