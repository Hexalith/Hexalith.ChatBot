...
- Latest-technology research not required for implementation: the story is constrained to repo-pinned .NET SDK `10.0.300`, `net10.0`, Dapr/Aspire/EventStore patterns, OpenAPI/NSwag generation, Fluent UI/FrontComposer patterns, and xUnit v3. No external package upgrade or new third-party API is in scope.
