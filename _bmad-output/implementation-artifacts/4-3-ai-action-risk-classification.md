...
- Do not add package upgrades for this story. Relevant pinned versions include SDK `10.0.302`, `net10.0`, Dapr `1.17.9`, Aspire `13.3.x`, Fluent UI Blazor `5.0.0-rc.3-26138.1`, ModelContextProtocol `1.3.0`, xUnit v3 `3.2.2`, Shouldly `4.3.0`, NSubstitute `5.3.0`, and Playwright `1.60.0`.
