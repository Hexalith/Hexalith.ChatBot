...
- Use repo-pinned stack only: .NET SDK `10.0.302`, `net10.0`, warnings-as-errors, central package management, Fluent UI v5 RC via FrontComposer, xUnit v3, Shouldly, NSubstitute, Playwright where needed. Do not add package versions inline or upgrade dependencies.
