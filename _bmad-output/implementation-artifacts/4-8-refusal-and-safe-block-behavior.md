...
- Reuse `System.Text.Json` and repo-pinned stack only: .NET SDK `10.0.302`, `net10.0`, central package management, xUnit v3, Shouldly, NSubstitute, bUnit/Playwright where needed, Fluent UI v5 RC through existing FrontComposer patterns. Do not add inline package versions or upgrade dependencies.
