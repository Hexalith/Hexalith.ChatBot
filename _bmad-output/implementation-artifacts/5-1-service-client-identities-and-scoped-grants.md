...
- Use repo-pinned stack only: .NET SDK `10.0.300`, `net10.0`, central package management, xUnit v3, Shouldly, NSubstitute, NetArchTest, existing Keycloak/Aspire/Dapr patterns. Do not add inline package versions or upgrade dependencies.
